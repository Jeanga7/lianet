                ...
                <div className="flex justify-end">
                  <div className="inline-flex items-center rounded-full border border-[#1B365D]/15 bg-white/78 p-1 backdrop-blur-sm">
                    <button
                      ...
                      className={`inline-flex min-w-9 items-center justify-center rounded-full px-3 py-1 text-[10px] uppercase tracking-[0.08em] transition-colors ${locale === "fr" ? "bg-[#1B365D] font-semibold text-white" : "font-medium text-[#1B365D]/65 hover:text-[#40B4A6]"
                        }`}
                    ...
                    <button
                      ...
                      className={`inline-flex min-w-9 items-center justify-center rounded-full px-3 py-1 text-[10px] font-medium uppercase tracking-[0.08em] transition-colors ${locale === "en" ? "bg-[#1B365D] text-white" : "text-[#1B365D]/65 hover:text-[#40B4A6]"
                        }`}
